...
const NavbarGeneral = () => {
    return (
      <nav className="navbar navbar-expand-lg navbar-dark shadow-lg">
          ...
          <a className="navbar-brand p-3 mr-7" href="#">LogiGO</a>
                    ...
                    <ul className="navbar-nav ms-auto">
                      {/* Menú desplegable de configuraciones */}
                          <li className="nav-item dropdown">
                              <a className="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false" >Configuraciones</a>
